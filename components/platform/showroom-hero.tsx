      ...
      <div className="section-shell relative z-10 py-10 sm:py-14 lg:py-18">
        <div className="grid gap-6 lg:grid-cols-[0.92fr_1.08fr] lg:items-end lg:gap-8">
          <div className="max-w-2xl text-center lg:text-left">
            ...
            {car.subtitle ? <p className="mt-4 text-xs uppercase tracking-[0.22em] text-slate-300 sm:mt-5 sm:text-sm">{car.subtitle}</p> : null}
            ...
            <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row sm:justify-center lg:justify-start">
              <Link href="/vente" className="inline-flex items-center justify-center rounded-full border border-white bg-white px-5 py-3 text-sm font-semibold text-black transition hover:bg-[#ececec] sm:px-6">
                Voir tout le stock
              </Link>
              <a
