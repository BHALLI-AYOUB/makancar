      ...
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          <SectionHeading
            ...
            description="Makan Luxury Motors ne se limite pas au stock disponible. Nous accompagnons aussi le sourcing, l import et la presentation de vehicules premium selon votre besoin."
          />
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href={getWhatsAppHref(hero.whatsapp, hero.name)}
              target="_blank"
            ...
            <a
              href={getWhatsAppHref(hero.whatsapp, 'votre futur vehicule')}
              target="_blank"
              rel="noopener noreferrer"
